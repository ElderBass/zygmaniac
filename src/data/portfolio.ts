...
export const videoPortfolio: PortfolioItem[] = [
  {
    ...
    summary: 'A polished branded spot built around atmosphere, ritual, and quiet detail.',
    description: [
  ...
  },
  {
    ...
    summary: 'A crisp commercial edit with approachable energy and brand clarity.',
    description: [
...
export const writingPortfolio: PortfolioItem[] = [
  {
    ...
    summary: 'A speculative fiction piece in an anthology of strange maps and stranger waters.',
    description: [
